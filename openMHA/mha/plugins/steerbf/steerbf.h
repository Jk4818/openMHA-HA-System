...
public:
    ...
    //Custom variables
    MHAParser::string_t angle_degree;
    MHAParser::string_t calibrate_north;
    MHAParser::string_t head_angle;
    MHAParser::string_t fix_beam;
    parser_int_dyn flip_head;

    void insert();
    float head_angle_float;
private:
    void update_cfg();
